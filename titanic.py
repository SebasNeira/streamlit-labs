...
# Agregamos title y texto al sidebar
...
st.success('tu cumple es : `%s`' % (today_date))
...
selected_class = sidebar.radio("Select Class",
...
st.success(f"Selected Option: {selected_sex!r}")
st.markdown("___")
